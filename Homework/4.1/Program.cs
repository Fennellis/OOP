...
StudentController.SortByID(ref group1);
PrintGroup(group1);

System.Console.WriteLine("----------------------------------\n");
System.Console.WriteLine("Удаление студента:");

StudentController.DeleteStudent(student3, group1);
PrintGroup(group1);

System.Console.WriteLine("----------------------------------\n");
System.Console.WriteLine("Сортировка по ФИО:");

StudentController.SortByFullName(ref group1);
PrintGroup(group1);
...
StudentController.SortStreams(lst);
